...
public final class PublicKey: LosslessStringConvertible, ExpressibleByStringLiteral, Codable, Equatable, Hashable {
    ...
    fileprivate convenience init(fromBytesEd25519 bytes: Data) throws {
    ...
    public static func fromBytesEd25519(_ bytes: Data) throws -> Self {
        try Self(fromBytesEd25519: bytes)
    }

    fileprivate convenience init(fromBytesEcdsa bytes: Data) throws {
...
extension PublicKey: TryProtobufCodable {
    ...
    internal convenience init(fromProtobuf proto: Proto_Key) throws {
        ...
        case .ed25519(let bytes):
            try self.init(fromBytesEd25519: bytes)
        ...
        case .ecdsaSecp256K1(let bytes):
            try self.init(fromBytesEcdsa: bytes)
        }
    }
